...
private val translations = mapOf(
    AppLanguage.EN to mapOf(
        ...
        "Group video call" to "Group video call",
        "Group audio call" to "Group audio call",
        "Calling group…" to "Calling group…",
        "{count} connected" to "{count} connected",
        "{count} members" to "{count} members",
        "Invite" to "Invite",
        "Add participant" to "Add participant",
        "Declined" to "Declined",
        "Ringing" to "Ringing",
        "Joined" to "Joined",
        "Missed" to "Missed",
        "Left" to "Left",
        "No participants available to invite." to "No participants available to invite.",
        ...
        "Camera and microphone permissions are required for calls." to "Camera and microphone permissions are required for calls.",
        "Camera and microphone permissions are disabled. Enable them in App Settings." to "Camera and microphone permissions are disabled. Enable them in App Settings.",
        "Camera permission is required for video calls." to "Camera permission is required for video calls.",
        "Open App Settings" to "Open App Settings",
        "Unmute" to "Unmute",
        "Mute" to "Mute",
        "Leave" to "Leave",
    ...
    AppLanguage.RO to mapOf(
        ...
        "Group video call" to "Apel video de grup",
        "Group audio call" to "Apel audio de grup",
        "Calling group…" to "Se apelează grupul…",
        "{count} connected" to "{count} conectați",
        "{count} members" to "{count} membri",
        "Invite" to "Invită",
        "Add participant" to "Adaugă participant",
        "Declined" to "Refuzat",
        "Ringing" to "Suna",
        "Joined" to "Conectat",
        "Missed" to "Ratat",
        "Left" to "Plecat",
        "No participants available to invite." to "Nu există participanți de invitat.",
        ...
        "Camera and microphone permissions are required for calls." to "Sunt necesare permisiunile pentru cameră și microfon pentru apeluri.",
        "Camera and microphone permissions are disabled. Enable them in App Settings." to "Permisiunile pentru cameră și microfon sunt dezactivate. Activează-le din setările aplicației.",
        "Camera permission is required for video calls." to "Este necesară permisiunea pentru cameră.",
        "Open App Settings" to "Deschide setările aplicației",
    ...
    AppLanguage.DE to mapOf(
        ...
        "Group video call" to "Gruppen-Videoanruf",
        "Group audio call" to "Gruppen-Audioanruf",
        "Calling group…" to "Gruppe wird angerufen…",
        "{count} connected" to "{count} verbunden",
        "{count} members" to "{count} Mitglieder",
        "Invite" to "Einladen",
        "Add participant" to "Teilnehmer hinzufügen",
        "Declined" to "Abgelehnt",
        "Ringing" to "Klingelt",
        "Joined" to "Beigetreten",
        "Missed" to "Verpasst",
        "Left" to "Verlassen",
        "No participants available to invite." to "Keine Teilnehmer zum Einladen verfügbar.",
        ...
        "Camera and microphone permissions are required for calls." to "Kamera- und Mikrofonberechtigung sind für Anrufe erforderlich.",
        "Camera and microphone permissions are disabled. Enable them in App Settings." to "Kamera- und Mikrofonberechtigung sind deaktiviert. Aktiviere sie in den App-Einstellungen.",
        "Camera permission is required for video calls." to "Kameraberechtigung ist für Videoanrufe erforderlich.",
        "Open App Settings" to "App-Einstellungen öffnen",
