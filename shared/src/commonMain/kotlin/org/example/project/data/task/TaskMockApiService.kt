...
class TaskMockApiService : TaskApi {
    ...
    private val tasks = mutableListOf(
        Task(id = 1, title = "Configurare Ktor", description = "Adaugă clientul HTTP în proiect", status = TaskStatus.COMPLETE, createdBy = 1, dueDate = "2026-07-01"),
        ...
        Task(id = 3, title = "Autentificare", description = "Implementează login și înregistrare", status = TaskStatus.TO_DO, createdBy = 1, dueDate = "2026-07-15"),
        Task(id = 4, title = "Coș de cumpărături", description = "Adaugă/elimină produse din coș", status = TaskStatus.BLOCKED, createdBy = 2, dueDate = "2026-07-18"),
        Task(id = 5, title = "Notificări push", description = "Integrare notificări pentru comenzi", status = TaskStatus.TO_DO, createdBy = 5, dueDate = "2026-07-22"),
